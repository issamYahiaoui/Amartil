                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class="infos">
                                                                ...
                                                                @if($model->property_type === "Apartment" || $model->property_type === "Houses and villas" )
                                                                    <div class="row">
                                                                        <div class="col-md-6">Chambres</div>
                                                                        <div class="col-md-6">{{$model->rooms}}</div>
                                                                    </div>
                                                                    <hr>

                                                                    <div class="row">
                                                                        <div class="col-md-6">Salles de bain</div>
                                                                        <div class="col-md-6">{{$model->bathrooms}}</div>
                                                                    </div>
                                                                    <hr>

                                                                    <div class="row">
                                                                        <div class="col-md-6">Chambres a coucher</div>
                                                                        <div class="col-md-6">{{$model->bedrooms}}</div>
                                                                    </div>
                                                                    <hr>

                                                                    <div class="row">
                                                                        <div class="col-md-6">Etages</div>
                                                                        <div class="col-md-6">{{$model->flour}}</div>
                                                                    </div>
                                                                    <hr>
