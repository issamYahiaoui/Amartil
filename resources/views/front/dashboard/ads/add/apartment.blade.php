...
@section('content')
    ...
    <div id="listar-content" class="listar-content">
        ...
        <div id="listar-content" class="listar-content">
            <form enctype="multipart/form-data" class="listar-formtheme listar-formaddlisting" method="POST" action="{{url('apartments')}}">
                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group listar-dashboardfield">
                                            ...
                                            <input type="number" name="total_aria" class="form-control" placeholder="">
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group listar-dashboardfield">
                                            ...
                                            <input type="text" name="additional_details" class="form-control" placeholder="">
                                        </div>
