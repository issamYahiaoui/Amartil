          ...
          <form class="listar-formtheme listar-formaddlisting listar-formwishlist">
               <fieldset>
                    ...
                    <div class="listar-dashboardwishlists">
                         ...
                         <div class="listar-themepost listar-placespost">
                              <figure class="listar-featuredimg"><a href="javascript:void(0);"><img src="https://cdn.yamaha-motor.eu/product_assets/2018/YZF1000R1SPL/475-75/2018-Yamaha-YZF-R1M-EU-Silver-Blu-Carbon-Studio-001.jpg" alt="image description" class="mCS_img_loaded"></a></figure>
                              <div class="listar-postcontent">
                                   <h3><a href="{{url('u/add-ad/motocycle')}}">Motocycles</a></h3>
                                   <span class="listar-catagory">Ajouter une annonce sur les Motos</span>
