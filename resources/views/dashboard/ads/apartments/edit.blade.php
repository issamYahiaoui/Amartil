                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="additional_details" type="text" class="form-control" placeholder="">{{$model->additional_details}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="description" class="row">
                                <div class="">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea id="descriptiontextarea" name="description" type="text" class="form-control" placeholder="">{{$model->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('js')
    ...
    <script src="{{asset('js/apartment/edit.js')}}"></script>
    <script>
        /* script */
        function initialize() {
