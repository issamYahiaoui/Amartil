        ...
        <div class="row">
            ...
            <div class="listar-themeposts listar-blogposts">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="listar-themepost listar-post">
                        <figure class="listar-featuredimg">
                            <a href="newsdetail.html"><img src="{{asset('front/images/post/img-17.jpg')}}" alt="image description"></a>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="listar-themepost listar-post">
                        <figure class="listar-featuredimg">
                            <a href="newsdetail.html"><img src="{{asset('front/images/post/img-18.jpg')}}" alt="image description"></a>
                            <a class="listar-postcategory" href="newsv2.html">Enjoy Life</a>
                        </figure>
                        <div class="listar-postcontent">
                            <figure class="listar-authorimg"><img src="{{asset('front/images/author/img-02.jpg')}}" alt="image description"></figure>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="listar-themepost listar-post">
                        <figure class="listar-featuredimg">
                            <a href="newsdetail.html"><img src="{{asset('front/images/post/img-19.jpg')}}" alt="image description"></a>
                            <a class="listar-postcategory" href="newsv1.html">Travel</a>
                        </figure>
                        <div class="listar-postcontent">
                            <figure class="listar-authorimg"><img src="{{asset('front/images/author/img-03.jpg')}}" alt="image description"></figure>
