                        ...
                        <div class="">
                                ...
                                <div class="listar-themepost listar-categorypost">
                                    <figure   class="listar-featuredimg">
                                        <a href="javascript:void(0);">
                                            <img style="height: 300px!important;" src="https://s-ec.bstatic.com/images/hotel/max1024x768/541/54198130.jpg" alt="image description">
                            ...
                            <div  class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="listar-themepost listar-categorypost">
                                    <figure  class="listar-featuredimg">
                                        <a href="javascript:void(0);">
                                            <img  style="height: 300px!important;" src="{{asset('front/images/post/img-09.jpg')}}" alt="image description">
                                            <div class="listar-contentbox">
                                                <div class="listar-postcontent">
                                                    <span class="listar-categoryicon listar-flip"><i class="icon-settings"></i></span>
                                                    <h3>Autres</h3>
